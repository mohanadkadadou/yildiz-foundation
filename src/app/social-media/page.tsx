      ...
      <div className="pt-24 pb-16">
        <div className="bg-gradient-to-br from-navy-900 to-navy-800 py-14 px-4 mb-12">
          <div className="container mx-auto text-center">
            <h1 className="text-3xl md:text-5xl font-bold text-white mb-3">Social Media</h1>
            <p className="text-blue-100 text-lg max-w-2xl mx-auto">Follow Yildiz Foundation across YouTube, Instagram, and WhatsApp</p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          <div className="uni-card overflow-hidden">
            <div className="bg-gradient-to-r from-red-600 to-red-500 p-5 text-white">
              ...
              <p className="text-red-100 text-sm">yildiz Education — 94+ videos</p>
            </div>
            ...
            <div className="p-5">
              <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">Latest uploads from our channel, updated automatically.</p>
              <a href={YOUTUBE_CHANNEL_URL} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white font-semibold py-3 rounded-xl transition-colors text-sm">
                Subscribe on YouTube <ExternalLink className="w-3.5 h-3.5" />
              </a>
            </div>
          </div>
          ...
          <div className="uni-card overflow-hidden">
            <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 p-5 text-white">
              ...
              <p className="text-pink-50 text-sm">@yildiz_edu — 34.6K followers</p>
            </div>
            ...
            <div className="p-5 pt-0 space-y-2">
              <p className="text-gray-500 dark:text-gray-400 text-sm">Stories update daily and can't be embedded here — tap through to see them live.</p>
          ...
          <div className="uni-card overflow-hidden">
            <div className="bg-gradient-to-r from-green-600 to-emerald-500 p-5 text-white">
              ...
              <p className="text-green-50 text-sm">Chat directly with our team</p>
            </div>
            <div className="p-5">
              <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-6">
                Get quick answers about universities, programs, and scholarships — message us directly on WhatsApp.
              </p>
