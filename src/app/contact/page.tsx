      ...
      <div className="pt-24 pb-16">
        <div className="bg-gradient-to-br from-navy-900 to-navy-800 py-14 px-4 mb-16">
          <div className="container mx-auto text-center">
            ...
            <p className="text-blue-100 text-lg">We are here to help you</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div className="space-y-6">
              <div className="flex items-start gap-4 p-5 bg-gray-50 dark:bg-navy-900 rounded-2xl border border-gray-100 dark:border-navy-800">
                ...
                <div><div className="font-semibold text-navy-900 dark:text-white">Phone</div>
              ...
              <div className="flex items-start gap-4 p-5 bg-gray-50 dark:bg-navy-900 rounded-2xl border border-gray-100 dark:border-navy-800">
                ...
                <div><div className="font-semibold text-navy-900 dark:text-white">Email</div>
              ...
              <div className="flex items-start gap-4 p-5 bg-gray-50 dark:bg-navy-900 rounded-2xl border border-gray-100 dark:border-navy-800">
                ...
                <div><div className="font-semibold text-navy-900 dark:text-white">Location</div>
                <span className="text-gray-600 dark:text-gray-300 text-sm">Istanbul, Turkey</span></div>
              </div>
              <div className="flex items-start gap-4 p-5 bg-gray-50 dark:bg-navy-900 rounded-2xl border border-gray-100 dark:border-navy-800">
                <div className="p-3 bg-navy-800 rounded-xl"><Clock className="w-5 h-5 text-white" /></div>
                <div><div className="font-semibold text-navy-900 dark:text-white">Working Hours</div>
                <span className="text-gray-600 dark:text-gray-300 text-sm">Mon-Sat: 9AM - 6PM</span></div>
              </div>
            ...
            <div className="lg:col-span-2">
              <form onSubmit={handleSubmit} className="bg-white dark:bg-navy-900 rounded-3xl p-8 border border-gray-100 dark:border-navy-800 shadow-lg space-y-5">
                <h2 className="text-2xl font-bold text-navy-900 dark:text-white mb-2">Send us a Message</h2>
